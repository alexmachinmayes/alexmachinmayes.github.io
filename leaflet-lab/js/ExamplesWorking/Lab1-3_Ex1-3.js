...
function getData(map){
    $.ajax("data/geoJSON/DecliningCities_min.geojson", {
        dataType: "json",
...
function calcPropRadius(attValue) {
    ...
    var area = attValue/10000 * scaleFactor;
...
//Problematic panel content - always first year in sequence?
    //build popup content string
    var panelContent = "<p><b>City:</b> " + feature.properties.CityName + "</p>";
...
//    var popupContent = "<p><b>City:</b> " + feature.properties.CityName + "</p>";
//    
//    var year = attribute.split("_")[1];
