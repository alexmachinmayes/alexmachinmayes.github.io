...
////Step 1 - Create the Leaflet map with createMap()
////Setting up map and setting default extent/zoom
////Creating interaction operator with basemap switching
...
//Step 2 - Import GeoJSON data with Ajax
function getData(map){
    //load the data
    $.ajax("data/geoJSON/DecliningCities_PercLossFrom2010_2.geojson", {
        dataType: "json",
...
//        $('#panel').append('<button class="skip" id="forward">Skip</button>');
        $('#reverse').html('<img src="img/Reverse_Button.svg">');
        $('#forward').html('<img src="img/Forward_Button.svg">');
...
function createPropSymbols(data, map, attributes){
    ...
    var geoJsonLayer = L.geoJson(data, {
        ...
        filter: function(feature, layer) {
            return feature.properties.PercLossBy_2011 > 0;},
        })
...
function createPopup(properties, attribute, layer, radius){
    ...
    var popupContent = "<p>City: <b>" + properties.CityName + "</b></p>";

    //add formatted attribute to panel content string
    var year = attribute.split("_")[1];
    popupContent += "<p>Population Loss From</p><p><b> 2010 - " + year + ": " + properties[attribute] + "%</b></p>";
...
function createLegend(map, attributes){
    var LegendControl = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            var svg = '<svg id="attribute-legend" width="175px" height="90px">';
...
function updateLegend(map, attribute){
    ...
    var year = attribute.split("_")[1];
    var content = "<h7>Total % population decrease for all cities currently displayed in red.<br>Min, mean, & max values for the year range:<br><b>2010-" + year + "</b></h7>";
        console.log(attribute);
